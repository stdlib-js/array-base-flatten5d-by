...
```javascript
import flatten5dBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten5d-by@v0.0.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten5d-by@v0.0.1-esm/index.mjs';
```
